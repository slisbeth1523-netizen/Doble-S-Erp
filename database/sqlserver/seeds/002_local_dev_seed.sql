...
VALUES
  ...
  ('accounting', 'accounting.journal-entries.read', 'Local read accounting journal entries'),
  ...
  ('accounting', 'accounting.trial-balance.read', 'Local read accounting trial balance'),
