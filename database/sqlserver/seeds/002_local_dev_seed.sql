...
VALUES
  ...
  ('sales', 'sales.credit-notes.read', 'Local read sales credit notes'),
  ('sales', 'sales.credit-notes.create', 'Local create sales credit notes'),
  ('sales', 'sales.credit-notes.post', 'Local post sales credit notes'),
