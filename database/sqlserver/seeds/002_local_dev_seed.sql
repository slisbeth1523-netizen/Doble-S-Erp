...
VALUES
  ...
  ('fiscal', 'dgii.electronic-invoices.read', 'Local read electronic invoices'),
  ('fiscal', 'dgii.electronic-invoices.configure', 'Local configure electronic invoices'),
  ('fiscal', 'dgii.electronic-invoices.emit', 'Local emit electronic invoices'),
  ('fiscal', 'dgii.certification.read', 'Local read DGII certification'),
  ('fiscal', 'dgii.certification.update', 'Local update DGII certification'),
