...
INSERT INTO core.Tenants (TenantId, Name, Slug)
VALUES (@TenantId, @TenantName, @TenantSlug);

INSERT INTO core.Companies (CompanyId, TenantId, LegalName, TradeName, TaxId)
VALUES (@CompanyId, @TenantId, @CompanyLegalName, @CompanyTradeName, @CompanyTaxId);

INSERT INTO security.Users (UserId, TenantId, DefaultCompanyId, Email, DisplayName, PasswordHash)
VALUES (@AdminUserId, @TenantId, @CompanyId, @AdminEmail, @AdminDisplayName, @AdminPasswordHash);

INSERT INTO security.UserCompanyAccess (TenantId, UserId, CompanyId, IsDefault)
VALUES (@TenantId, @AdminUserId, @CompanyId, 1);

INSERT INTO security.Roles (RoleId, TenantId, Code, Name, IsSystemRole)
VALUES (@AdminRoleId, @TenantId, N'ADMIN', N'Administrador', 1);

INSERT INTO security.UserRoles (TenantId, UserId, RoleId)
VALUES (@TenantId, @AdminUserId, @AdminRoleId);
