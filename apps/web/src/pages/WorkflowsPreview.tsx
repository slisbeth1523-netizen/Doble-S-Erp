...
export function WorkflowsPreview() {
  return (
    <div className="page-stack">
      <PageHeader
        description="Preview del Workflow Engine: definiciones, estados, transiciones, historial, guards, conditions y actions base."
      ...
      <Card>
        ...
        <Table
          ...
          rows={[
            ...
            ["Execution", <Badge tone="green">Listo</Badge>, "Transiciones validas sobre entidades genericas"],
      ...
      <EmptyState title="Sin diseñador visual" description="El diseñador de workflows queda fuera de UX-001." />
      <Card>
        <h2>Estados de UX</h2>
        <div className="state-demo">
          ...
          <EmptyState title="Sin definiciones visibles" description="No se administran definiciones reales desde esta preview." />
        </div>
      </Card>
    </div>
  );
